...
מקור הנתונים: `outputs\experiment_v6/metrics.csv`, עם סף הקבלה מתוך `results.json`.
...
חציון זמן העיבוד: 32.29 מילישניות;
חציון ההשהיה: 58.18 מילישניות.
...
התקבלו 339 אומדנים תקינים מתוך 421 פריימים שעובדו.
...
```powershell
python -m metrics.export_report_figures --run outputs\experiment_v6
```
