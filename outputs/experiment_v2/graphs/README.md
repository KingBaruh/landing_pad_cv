...
מקור הנתונים: `outputs\experiment_v2/metrics.csv`, עם סף הקבלה מתוך `results.json`.
...
התקבלו 119 אומדנים תקינים מתוך 188 פריימים שעובדו.
...
```powershell
python -m metrics.export_report_figures --run outputs\experiment_v2
```
