...
מקור הנתונים: `outputs\experiment_v5/metrics.csv`, עם סף הקבלה מתוך `results.json`.
...
חציון זמן העיבוד: 24.43 מילישניות;
חציון ההשהיה: 48.70 מילישניות.
...
התקבלו 175 אומדנים תקינים מתוך 225 פריימים שעובדו.
...
```powershell
python -m metrics.export_report_figures --run outputs\experiment_v5
```
