...
מקור הנתונים: `outputs\experiment_v4/metrics.csv`, עם סף הקבלה מתוך `results.json`.
...
חציון זמן העיבוד: 29.94 מילישניות;
חציון ההשהיה: 57.08 מילישניות.
...
התקבלו 250 אומדנים תקינים מתוך 252 פריימים שעובדו.
...
```powershell
python -m metrics.export_report_figures --run outputs\experiment_v4
```
