...
מקור הנתונים: `outputs\experiment_v1/metrics.csv`, עם סף הקבלה מתוך `results.json`.
...
חציון זמן העיבוד: 24.96 מילישניות;
חציון ההשהיה: 48.65 מילישניות.
...
התקבלו 253 אומדנים תקינים מתוך 289 פריימים שעובדו.
