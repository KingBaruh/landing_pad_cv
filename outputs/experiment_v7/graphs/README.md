...
מקור הנתונים: `outputs\experiment_v7/metrics.csv`, עם סף הקבלה מתוך `results.json`.
...
חציון זמן העיבוד: 58.48 מילישניות;
חציון ההשהיה: 103.95 מילישניות.
...
התקבלו 224 אומדנים תקינים מתוך 228 פריימים שעובדו.
...
```powershell
python -m metrics.export_report_figures --run outputs\experiment_v7
```
