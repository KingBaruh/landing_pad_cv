...
מקור הנתונים: `outputs\experiment_v8_landing/metrics.csv`, עם סף הקבלה מתוך `results.json`.
...
חציון זמן העיבוד: 24.78 מילישניות;
חציון ההשהיה: 47.97 מילישניות.
...
התקבלו 316 אומדנים תקינים מתוך 323 פריימים שעובדו.
...
```powershell
python -m metrics.export_report_figures --run outputs\experiment_v8_landing
```
